...
<div class="bg-overlay">
	<div class="page-content">
		<div class="form-v2-content">
			<div class="form-left">
				<img src="images/image_5.jpg" width="90%" height="100%"alt="form">
				<div class="text-1">
					<p>Find Your Friend<span>Be Happy</span></p>
				</div>
			</div>
			<form class="form-detail" action="" method="post" id="myform">
				<h2>Register Your Pet Please</h2>
				<div class="form-row">
                    <div class="form-group">
                <i class="fas fa-user"></i>
					<input type="text" name="full_name" id="full_name" class="input-text" placeholder=" &nbsp &nbsp &nbsp &nbsp Owner Full Name">
				</div>
              </div>

			  <div class="form-row">
			  <div class="form-group">
                <input type="text"  id="address" class="input-text" placeholder="Enter address">
            </div>
			</div>
            <div class="form-row">
			<div class="form-group">
                <div class="col-md-4">
                    <input type="text"  id="city" class="input-text" placeholder="Enter city">
                </div>
</div>
<div class="form-group">
                <div class="col-md-4">
                    <input type="text" id="state" class="input-text" placeholder="Enter state">
                </div>
			</div>
			</div>
			<div class="form-row">
                <div class="form-group col-md-4">
                    <input type="text" id="country" class="input-text" placeholder="Enter country">
                </div>
            </div>
            <div class="form-group">
                <input type="text"  id="zip" class="input-text" placeholder="Enter zip code">
            </div>
              ...
              <div class="form-group">		
                ...
                <i class="fas fa-phone"></i>
					<input type="text" name="your_email" id="your_email" class="input-text" placeholder=" &nbsp &nbsp &nbsp &nbsp Owner Telephone No"required pattern="[^@]+@[^@]+.[a-zA-Z]{2,6}">
				</div>
</div>
				<div class="form-row">
                <div class="form-group">
