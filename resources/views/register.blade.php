		...
		<div class="form-v2-content">
			...
			<h2>Create Your Account</h2>
				...
				<div class="form-row">
					...
					<input type="text" name="security_code" id="security_code" class="input-text" placeholder=" Enter your 8 digit security code">
				</div>
              </div>
				<div class="form-row">
                    <div class="form-group">
...
<div class="form-group">
                <input type="text"  id="status" name="status" class="input-text" value="new user" >
            </div>
